...
const CREATE_INPUT = {
  ...
  afternoonDescription: "exampleAfternoonDescription",
  afternoonPoint: "exampleAfternoonPoint",
  createdAt: new Date(),
  eveningDescription: "exampleEveningDescription",
  eveningPoint: "exampleEveningPoint",
  id: "exampleId",
  morningDescription: "exampleMorningDescription",
  price: 42.42,
  startpoint: "exampleStartpoint",
  updatedAt: new Date(),
};
const CREATE_RESULT = {
  accommodation: "exampleAccommodation",
